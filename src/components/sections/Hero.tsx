...
const TextContent = styled.div`
  ...
  min-height: 500px; /* Space reserved for text + stats */
...
const ProfileIconWrapper = styled(motion.div)`
  width: 300px;
  height: 300px;
  border-radius: 50%;
  ...
  align-items: center;
  justify-content: center;
  background: ${({ theme }) => `linear-gradient(135deg, ${theme.colors.surface}, ${theme.colors.background})`};
  color: ${({ theme }) => theme.colors.primary};
  overflow: hidden;
  flex-shrink: 0;
...
const yearsOfExp = currentYear - 2019;
        ...
        <TextContent>
          ...
          >
            ...
            <Description variants={itemVariants}>
              {user?.bio || `Desenvolvedor Full Stack com mais de ${yearsOfExp} anos de experiência,
